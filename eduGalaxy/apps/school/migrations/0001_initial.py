# Generated by Django 2.1.4 on 2019-08-02 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(blank=True, null=True, verbose_name='수정날짜')),
                ('modified_ip', models.CharField(max_length=20, verbose_name='게시판 수정 ip')),
                ('admin_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.AdminPost')),
                ('edu_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            ...
            name='school_info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.SchoolInfo'),
        ),
    ]
