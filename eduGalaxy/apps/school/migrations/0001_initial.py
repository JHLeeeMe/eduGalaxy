# Generated by Django 2.1.4 on 2019-07-09 08:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sch_ooe', models.CharField(max_length=20, verbose_name='시도교육청')),
                ('sch_lea', models.CharField(max_length=20, verbose_name='지역교육청')),
                ('sch_location', models.CharField(max_length=20, verbose_name='지역')),
                ('sch_inf_code', models.CharField(max_length=11, verbose_name='정보공시 학교코드')),
                ('sch_name', models.CharField(max_length=20, verbose_name='학교명')),
                ('sch_grade_code', models.IntegerField(verbose_name='학교급코드')),
                ...
                ('sch_anniversary', models.IntegerField(verbose_name='개교기념일')),
                ('sch_estab_date', models.IntegerField(verbose_name='설립일')),
                ('sch_dong_code', models.IntegerField(verbose_name='법정동코드')),
