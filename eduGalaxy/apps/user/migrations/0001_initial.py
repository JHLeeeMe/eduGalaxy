    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.CharField(max_length=250, verbose_name='학생정보')),
                ('parent', models.CharField(max_length=200, verbose_name='학부모정보')),
                ('schoolauth', models.CharField(max_length=100, verbose_name='학교관계자정보')),
                ('child', models.CharField(max_length=100, verbose_name='자녀정보')),
