# Generated by Django 2.1.4 on 2019-09-11 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.CharField(max_length=250, null=True, verbose_name='학생정보')),
                ('parent', models.CharField(max_length=200, null=True, verbose_name='학부모정보')),
                ('schoolauth', models.CharField(max_length=100, null=True, verbose_name='학교관계자정보')),
                ('child', models.CharField(max_length=100, null=True, verbose_name='자녀정보')),
                ('create_date', models.DateTimeField(blank=True, null=True, verbose_name='생성날짜')),
            ],
        ),
        migrations.CreateModel(
            name='Log',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_doc', models.FileField(null=True, upload_to='signup/schoolAuth', verbose_name='인증 서류')),
